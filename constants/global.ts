export const routes = [
  { name: 'Accueil', label: 'accueil', path: '/', caption: 'Un petit peu à propos de nous.', },
  { name: 'Articles', label: 'articles', path: '/articles', caption: 'Des articles sur nos expériences.', },
  { name: 'Carte du Monde', label: 'map-monde', path: '/map-monde', caption: 'Tout les endroits visités.', },
  { name: 'Journal', label: 'journal', path: '/journal', caption: 'Notre journal quotidien.', },
  { name: 'Images', label: 'images', path: '/images', caption: 'Un gros bol avec toutes nos images.', },
